...
import { CalendarPlus, Mic, Send } from "lucide-react";
      ...
      <div className="lg:col-span-1">
        <div className="flex flex-col items-center rounded-xl border border-slate-200 bg-white px-6 py-10 text-center">
          ...
          <p className="mt-1.5 text-sm text-slate-500">
            Test a real-time voice conversation with the assistant.
          </p>
          <button
            type="button"
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-0.5 text-xs text-slate-400">
                Test the assistant's text responses and tool calling.
              </p>
            </div>
            <button
              type="button"
